...
const BehaviorScript bhvToadMessage[] = {
    ...
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_IMPORTANT | RAND_TYPE_CREATE_AVOIDANCE_POINT | RAND_TYPE_HAS_SAFE_GROUND_AROUND),
    LOAD_ANIMATIONS(oAnimations, toad_seg6_anims_0600FB58),
...
const BehaviorScript bhvBobombBuddyOpensCannon[] = {
    ...
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_SAFE | RAND_TYPE_CREATE_AVOIDANCE_POINT | RAND_TYPE_HAS_SAFE_GROUND_AROUND),
    GOTO(bhvBobombBuddy + 1 + 1 + 1 + 1),
};
...
const BehaviorScript bhvFlyingBookend[] = {
    ...
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_CAN_BE_UNDERWATER),
